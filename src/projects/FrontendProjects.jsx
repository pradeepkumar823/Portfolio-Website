...
export default function FrontendProjects() {
  const project = PORTFOLIO_DATA.projects.find((p) => p.id === "frontendprojects");
  ...
  return (
    <div className="glass-panel p-8 max-w-4xl mx-auto my-8">
      ...
      <h1 className="text-4xl font-black text-white my-4">{project?.title || "React Component Suite"}</h1>
