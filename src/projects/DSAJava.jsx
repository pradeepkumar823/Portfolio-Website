...
export default function DSAJavaProject() {
  const project = PORTFOLIO_DATA.projects.find((p) => p.id === "dsajava");
  ...
  return (
    <div className="glass-panel p-8 max-w-4xl mx-auto my-8">
      <span className="px-3.5 py-1 rounded-full bg-purple-500/10 text-purple-400 text-xs font-bold uppercase tracking-wider">
        {project?.badge || "Backend / DSA"}
      </span>
      <h1 className="text-4xl font-black text-white my-4">{project?.title || "DSA Java Archive"}</h1>
